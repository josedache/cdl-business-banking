...
type DashboardAccountSetupPinSetupVerificationProps =
  {} & DashboardAccountSetupContentProps;

export default function DashboardAccountSetupPinSetupVerification(
  props: DashboardAccountSetupPinSetupVerificationProps
) {
        ...
        <div className="px-6 pt-6 pb-8 flex justify-center items-center w-full">
          <div className="w-full">
            ...
            <Typography className="text-neutral-500 w-full">
              Use a PIN you can remember, it'll be used for all transactions
            </Typography>
            <div className="grid justify-center gap-4 mt-10">
              <OtpInput
                value={formik.values.confirmTransactionPin}
                onChange={(otp) => {
                  formik.setFieldValue("confirmTransactionPin", otp);
                }}
                numInputs={6}
                shouldAutoFocus
                inputType="password"
