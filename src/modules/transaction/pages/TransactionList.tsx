...
import { Button, Icon, Paper, Tab, Tabs, Typography } from "@mui/material";
...
function TransactionList() {
  ...
  const topItemIntersectionObserver = useIntersectionObserver((entries) => {
    ...
    if (
      ...
      setPageState((p) => ({ ...p, pageIndex: p.pageIndex + 1 }));
    }
  });
  ...
  return (
    <>
      <Paper className="p-4 md:p-8 space-y-4" elevation={0}>
